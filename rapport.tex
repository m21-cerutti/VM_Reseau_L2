...
>>>>>>> 945978854f0869a3679a66b9bad103efb715d0bc
		...
		Ce fut réalisé grâce aux formalismes d'envoi dans la class CommandNetwork, ou on encodait la commande au départ de string en byte array avec enc\textunderscore command, et on décodait et on altérait le modèle avec dec_command, qui vérifier aussi si la commande existait. Les commandes réseau sont de cette forme :
